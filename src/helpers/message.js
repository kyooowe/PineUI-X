...
const Message = () => {
    const PreparingMessage = async (fileName) => {
        ...
        console.log(chalk.blueBright('Customizing the file based on your input request. 🔧🔨\n'))
    ...
    const ErrorMessage = (customMessage) => {
        if (customMessage) { console.log(chalk.redBright(`${customMessage}\n`)) } else { console.log(chalk.redBright('Error occured, you can start again to try our Pine UI. \n')) }
    }
